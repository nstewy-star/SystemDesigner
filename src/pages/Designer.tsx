...
export function Designer({ onBack }: DesignerProps) {
  ...
  const getScaledSize = (d: Device) => {
    ...
    const scale = (currentProject?.device_scale ?? 50) / 400;
            ...
            <div className="p-4">
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input type="range" min="0" max="100" value={deviceScale} onChange={(e) => updateProject({ device_scale: parseInt(e.target.value) })} className="w-full h-2 bg-blue-200 rounded-lg appearance-none cursor-pointer" />
                </div>
                <div>
